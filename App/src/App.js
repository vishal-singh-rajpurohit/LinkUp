...
import SafeCall from './Secure/SafeCall';
import { VideoCallModal } from './Components/Minors/Call';
  ...
  return (
    <Routes >
      <Route path='/' element={<Layout />} >
        ...
        <Route path='/call/videocall' element={<SafeCall ><VideoCallModal /></SafeCall>} />
